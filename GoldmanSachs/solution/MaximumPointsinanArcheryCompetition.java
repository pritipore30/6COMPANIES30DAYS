...
public class MaximumPointsinanArcheryCompetition {
	...
	public static Pair<Boolean, Integer> getShotableAndPoint(int mask, int leftArrows, int[] aliceArrows) {
		int point = 0;
		for (int i = 0; i < 12; ++i) {
			if ((mask >> i & 1) == 1) {
	...
	public static int[] getBobsArrows(int mask, int leftArrows, int[] aliceArrows) {
